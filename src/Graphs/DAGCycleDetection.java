...
/**
 * http://www.keithschwarz.com/interesting/code/dijkstra/DirectedGraph.java.html
 * http://stackoverflow.com/questions/20739736/should-exceptions-be-thrown-symmetrically?noredirect=1#comment31076027_20739736
 *
 * References:
 * http://stackoverflow.com/questions/20739736/should-exceptions-be-thrown-symmetrically
 *
...
public final class DAGCycleDetection {
    ...
    private static <T> boolean dfs (GraphCycleDetection<T> graph,
        ...
        for (T t : graph.nodesFrom(node)) {
            if (dfs(graph, t, visitedNodes, completedNodes)) return true;
        }
